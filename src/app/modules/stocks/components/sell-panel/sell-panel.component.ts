...
export class SellPanelComponent implements OnInit {
  ...
  constructor(private userService: UserService,
    ...
    private dialogRef: MatDialogRef<SellPanelComponent>) { 
    this.capital = 0;
    this.displayValue = "1";
  ...
  ngOnInit(): void {
    ...
    this.feesObs = timer(1, 1000).pipe(
      ...
      this.portofolioService.GatherSellOrderTaxes(this.ticker,
